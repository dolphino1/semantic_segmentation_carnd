...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    # TODO: Implement function
    conv_out = tf.layers.conv2d(vgg_layer7_out, num_classes, 1,
                                padding='same',
                                kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    deconv_1 = tf.layers.conv2d_transpose(conv_out, num_classes, 4, 2,
                                          padding='same',
                                          kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    deconv_2 = tf.layers.conv2d_transpose(skip_conn_1, num_classes, 4, 2,
                                          padding='same',
                                          kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    # Up-sample
    deconv_3 = tf.layers.conv2d_transpose(skip_conn_2, num_classes, 16, 8,
                                          padding='same',
                                          kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
...
def run():
    ...
    with tf.Session() as sess:
        ...
        correct_label = tf.placeholder(
            dtype=tf.float32, shape=(None, None, None, num_classes))
        ...
        tf.train.write_graph(sess.graph_def, '', 'model.pd', False)
